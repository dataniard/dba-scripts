-- Busca Esperas
	...
	--   ses.client_identifier, -- Esta SI
	   ses.wait_class,
	   decode(state,'WAITING',wait_class,'CPU') event_aas, 
	   event,
...
--	and p.spid = '14230'
	...
	--and ses.username like '%UAD_ETL_P%'
	--and ses.sid  in (421)
	and (ses.WAIT_CLASS <> 'Idle' -- Esta SI
	or ses.PROGRAM like '%(J%'
	or ses.PROGRAM like '%(P%'
	or ses.PROGRAM like '%(D%'
	or ses.program like '%rman%') -- Esta SI
	--and ses.machine like '%apps524vx'
	--and upper(ses.service_name) like '%SUMMA%'
